...
int main(int argc, char *argv[]) {
  ...
  std::string catStatement = "CREATE TABLE categories(id INTEGER PRIMARY KEY "
  ...
  std::string itemStatement =
      "CREATE TABLE items(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT "
      "NULL, quantity INTEGER, price REAL, category_id INTEGER, FOREIGN "
